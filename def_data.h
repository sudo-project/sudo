...
#define def_umask_override      (sudo_defs_table[58].sd_un.flag)
#define I_UMASK_OVERRIDE        58
...
#define def_role                (sudo_defs_table[62].sd_un.str)
#define I_ROLE                  62
#define def_type                (sudo_defs_table[63].sd_un.str)
#define I_TYPE                  63
